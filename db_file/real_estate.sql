...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2977592066ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="232">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=real_estate&table=users">`real_estate`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=real_estate&table=properties">`real_estate`.`properties`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=real_estate&table=submitted_properties">`real_estate`.`submitted_properties`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=real_estate&table=agents">`real_estate`.`agents`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=real_estate&table=admin">`real_estate`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=real_estate&table=property_images">`real_estate`.`property_images`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=real_estate&table=inquiries">`real_estate`.`inquiries`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=code_camp_bd_fos&table=users">`code_camp_bd_fos`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=code_camp_bd_fos&table=admin">`code_camp_bd_fos`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auth-sys&table=users">`auth-sys`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7e412354234b3c564237244e366c5f7c">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="232"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
