            ...
            if (isset($_GET['id'])) {
                ...
                if ($result->num_rows === 1) {
                    ...
                    <form action="update_user.php" method="POST">
                        <input class="form-control shadow-none" type="hidden" name="agent_id" value="<?php echo $user['agent_id']; ?>">
                        <label class="form-label" style="font-weight: 500;" >username</label>
                        <input class="form-control shadow-none" type="text" name="agent_name" value="<?php echo $user['agent_name']; ?>">
