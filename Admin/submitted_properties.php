          ...
          <div class="col-lg-10 col-md-8 col-sm-12 mb-5 px-4">
            <div class="bg-white rounded shadow p-4">
              ...
              <?php     
                ...
                $query = "SELECT * FROM submitted_properties";
                ...
                if ($result->num_rows > 0) {
                  ...
                  echo "<tr>
                          ...
                          <th scope='col'>Image_1 url</th>
                          <th scope='col'>Image_2 url</th>
                          <th scope='col'>Image_3 url</th>
                        </tr>
                        </thead>";
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row['image_1'] . "</td>";
                    echo "<td>" . $row['image_2'] . "</td>";
                    echo "<td>" . $row['image_3'] . "</td>";
                    // echo "<td>
                    //         <a href='edit_submitted.php?id=" . $row['property_id'] . "'>Edit</a>
                    //         <a href='delete_submitted.php?id=" . $row['property_id'] . "'>Delete</a>
                    //       </td>";
                    echo "</tr>";
                    echo "</tbody>";
                  }
