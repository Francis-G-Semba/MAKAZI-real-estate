            ...
            if (isset($_GET['id'])) {
                ...
                if ($result->num_rows === 1) {
                    ...
                    <form action="update_property.php" method="POST">
                        <input class="form-control shadow-none" type="hidden" name="property_id" value="<?php echo $property['property_id']; ?>">
                        <label class="form-label" style="font-weight: 500;" >Property Type</label>
                        <input class="form-control shadow-none" type="text" name="property_type" value="<?php echo $property['property_type']; ?>">
                        <label class="form-label" style="font-weight: 500;">Property Status</label>
                        <select class="form-select shadow-none" name="status" id="status">
                            <option value="For Rent" <?php if ($property['property_status'] === 'For Rent') echo 'selected'; ?>>For Rent</option>
                            <option value="For Sale" <?php if ($property['property_status'] === 'For Sale') echo 'selected'; ?>>For Sale</option>
                        </select>
                        <label class="form-label" style="font-weight: 500;" >Location</label>
                        <input class="form-control shadow-none" type="text" name="location" value="<?php echo $property['location']; ?>">
                        <label class="form-label" style="font-weight: 500;" >Price</label>
                        <input class="form-control shadow-none" type="text" name="price" value="<?php echo $property['price']; ?>">
                        <!-- Add more property fields as needed -->
                        <button  class="btn btn-dark shadow-none mt-3" type="submit">Update Property</button>
                    </form>
                    <?php
                } else {
