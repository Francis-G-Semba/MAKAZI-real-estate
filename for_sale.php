...
<div class="my-4 px-4 ">
        <h2 class="fw-bold h-font text-center">Properties For Sale</h2>
...
<div class="container">
    ...
    <?php
        ...
        // Retrieve the "For Sale" properties from the database with pagination
        $query = "SELECT * FROM properties WHERE property_status = 'For Sale' ORDER BY property_id DESC LIMIT $offset, $resultsPerPage";
  ...
  <div class="card border-0 shadow" style="max-width: 350px; margin: auto; max-height: 500px; min-height: 400px;">
    ...
    <div class="card-body" style="overflow-y: auto;">
        ...
        // Pagination
        $totalPropertiesQuery = "SELECT COUNT(*) as total FROM properties WHERE property_status = 'For Sale'";
    ...
    echo "No properties available For Sale.";
}
